package mx.edu.utng.oic.gestionestudiantes.ui.screens
...
import mx.edu.utng.oic.gestionestudiantes.data.model.Estudiante
        ...
        Column(
            ...
            Button(
                onClick = {
                    ...
                    if (nombre.isNotBlank() && edadInt != null && edadInt in 15..100 &&
                        carrera.isNotBlank() && promedioDouble != null && promedioDouble in 0.0..100.0
                    ) {
                        onGuardarClick(nombre, edadInt, carrera, promedioDouble)
                    } else {
                        // Activar todos los errores si hay campos inválidos
