package mx.edu.utng.oic.gestionestudiantes.ui.theme
...
fun GestionEstudiantesTheme(
    ...
    MaterialTheme(
        ...
        typography = MaterialTheme.typography, // Nota: Se asume que 'Typography' es parte de MaterialTheme o está definido externamente. Usaré MaterialTheme.typography por defecto si no se proporcionó el código de tipografía.
        content = content
    )
}